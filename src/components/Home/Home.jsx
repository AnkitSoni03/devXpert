    ...
    return (
        <div className="mx-auto w-full max-w-7xl bg-gradient-to-b from-gray-50 to-white">
            ...
            <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
                ...
                <div className="absolute inset-0 w-full sm:my-20 sm:pt-1 pt-12 h-full">
                    <img className="w-120 object-cover" src="/public/home7.webp" alt="Developer coding" />
                </div>
            </aside>
            ...
            <div className="grid place-items-center sm:mt-20">
                <img className="sm:w-200 rounded-lg shadow-2xl" src="/public/home8.webp" alt="Developers collaborating" />
            </div>
            ...
            <div className="bg-gray-50 py-16 my-16 border-t border-b border-gray-200">
                <div className="max-w-4xl mx-auto px-4">
                    <div className="flex flex-col items-center">
                        <img className="w-24 h-24 rounded-full object-cover mb-6" src="/public/home10.avif" alt="Testimonial" />
